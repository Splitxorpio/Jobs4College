...
if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO jobuser (username, password) VALUES ('$username','$password')";
...
<body>
    <div class="container">
        <div class="container-object">
            <h1>Congrats! You are as a Job Recruiter!</h1>
            ...
            <br>
            <a href="jobsigning.php" class="start">Sign In</a>
        </div>
    </div>
</body>
